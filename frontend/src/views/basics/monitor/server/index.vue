...
import {
  ...
  updateServerInfo
} from "@/api/basics/monitor/server";
import InstrumentBoard from "@/views/basics/monitor/server/components/InstrumentBoard";
import LineChart from "@/views/basics/monitor/server/components/LineChart";
