...
<script>
import { getGenTable, updateGenTable } from "@/api/basics/tool/gen";
import { optionselect as getDictOptionselect } from "@/api/basics/system/dict/type";
import { listMenu as getMenuTreeselect } from "@/api/basics/permission/menu";
