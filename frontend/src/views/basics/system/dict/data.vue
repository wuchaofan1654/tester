...
<script>
import { addData, delData, exportData, getData, listData, updateData } from "@/api/basics/system/dict/data";
import { getType, listType, clearCache } from "@/api/basics/system/dict/type";
