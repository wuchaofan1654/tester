<template> 
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true">
      ...
      <el-form-item label="集合状态" prop="status">
        <el-select
    ...
    <el-table v-loading="loading" :data="pointList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="团队" prop="dept.deptName" :show-overflow-tooltip="true" />
      <el-table-column label="接口数" prop="apis" width="100" :show-overflow-tooltip="true" />
...
<script>
import {listCaseSuite} from '@/api/projects/case'
...
export default {
  ...
  methods: {
    getList() {
      this.loading = true;
      listCaseSuite(this.queryParams).then(response => {
        this.loading = false;
