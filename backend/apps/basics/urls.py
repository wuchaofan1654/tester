...
from apps.basics.permission.views import GetUserProfileView, GetRouters
from apps.basics.utils.login import LoginView, LogoutView
...
urlpatterns = [
    ...
    re_path(r'^permission/', include('apps.basics.permission.urls')),
    re_path(r'^system/', include('apps.basics.system.urls')),
    re_path(r'^celery/', include('apps.basics.celery.urls')),
    re_path(r'^monitor/', include('apps.basics.monitor.urls')),
