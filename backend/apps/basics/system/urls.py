...
from apps.basics.system.views import DictDataModelViewSet, DictDetailsModelViewSet, \
...
router.register(r'login_info', LoginInforModelViewSet)
...
urlpatterns = [
    ...
    # 清除废弃文件
    re_path('clearsavefile/', SaveFileModelViewSet.as_view({'post': 'clear_save_file', })),
    # 获取系统信息cpu、内存、硬盘
