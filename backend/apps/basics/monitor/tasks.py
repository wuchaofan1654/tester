...
from apps.basics.utils.decorators import BaseCeleryApp
...
@BaseCeleryApp(name='apps.basics.monitor.tasks.get_monitor_info', save_success_logs=False)
...
@BaseCeleryApp(name='apps.basics.monitor.tasks.clean_surplus_monitor_info')
