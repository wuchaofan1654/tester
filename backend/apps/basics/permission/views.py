...
from apps.basics.permission.permissions import CommonPermission, DeptDestroyPermission
...
from apps.basics.permission.filters import MenuFilter, DeptFilter, PostFilter, RoleFilter, UserProfileFilter
from apps.basics.permission.models import Role, Menu, Dept, Post
from apps.basics.permission.serializers import UserProfileSerializer, MenuSerializer, RoleSerializer, \
...
from apps.basics.system.models import DictDetails
