...
MIDDLEWARE = [
    ...
    'apps.basics.op_drf.middleware.ApiLoggingMiddleware',  # 用于记录API访问日志
    'apps.basics.op_drf.middleware.PermissionModeMiddleware',  # 权限中间件
]
# 允许跨域源
...
JWT_AUTH = {
    ...
    'JWT_PAYLOAD_HANDLER': 'apps.basics.utils.jwt_util.jwt_payload_handler',
    'JWT_GET_USER_SECRET_KEY': 'apps.basics.utils.jwt_util.jwt_get_user_secret_key',
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'apps.basics.utils.jwt_util.jwt_response_payload_handler',
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'apps.basics.utils.authentication.RedisOpAuthJwtAuthentication',
    ...
    'DEFAULT_PAGINATION_CLASS': 'basics.op_drf.pagination.Pagination',
    'DEFAULT_FILTER_BACKENDS': ('django_filters.rest_framework.DjangoFilterBackend',),
    'EXCEPTION_HANDLER': 'apps.basics.utils.exceptions.op_exception_handler',
}
# ================================================= #
# ************** 登录方式配置  ************** #
# ================================================= #
AUTHENTICATION_BACKENDS = (
    'apps.basics.utils.backends.CustomBackend',
    'apps.basics.utils.backends.SessionAuthentication',
)
